...
export class DashboardComponent implements OnInit {
  ...
  @ViewChild('paginatorWithPlan') paginatorWithPlan!: MatPaginator;
  @ViewChild('paginatorWithoutPlan') paginatorWithoutPlan!: MatPaginator;
  @ViewChild('paginatorIndividual') paginatorIndividual!: MatPaginator;
  ...
  ngOnInit() {
    this.userService.getUsers().subscribe((customerData: any[]) => {
      ...
      this.dataSourceWithPlan.sort = this.sort;
      this.dataSourceWithPlan.paginator = this.paginatorWithPlan;

      this.dataSourceWithoutPlan.sort = this.sort;
      this.dataSourceWithoutPlan.paginator = this.paginatorWithoutPlan;

      this.dataSourceIndividual.sort = this.sort;
      this.dataSourceIndividual.paginator = this.paginatorIndividual;

      this.dataSourceBusiness.sort = this.sort;
      this.dataSourceBusiness.paginator = this.paginatorBusiness;
    });
